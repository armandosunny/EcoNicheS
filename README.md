...
### This is Version 1.5.0, last updated on May 23, 2026. Future versions will include additional analyses and enhancements.
...
packages <- c("shiny", "terra", "usdm", "spatstat.univar", "spatstat.explore", "spatstat.model", 
  "spatstat.geom", "spatstat.explore", "gam", "biomod2", "RColorBrewer", 
...
<img width="271" height="352" alt="Captura de pantalla 2025-08-24 a la(s) 7 32 31 a m" src="https://github.com/user-attachments/assets/0400e75b-5fac-4118-a735-2fff867bb68d" />
...
![Captura de pantalla 2025-05-27 a la(s) 9 12 47 a m](https://github.com/user-attachments/assets/a622e8ea-1fd8-4340-a0c4-d5ed94ed0c79)

![Captura de pantalla 2025-06-06 a la(s) 10 11 56 a m](https://github.com/user-attachments/assets/372bc3a7-1645-487a-9f30-74aa7e96d35e)
