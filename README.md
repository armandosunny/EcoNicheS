...
In this module we will explore Niche Modeling Analysis and niche overlap thanks to ENMTools. For such a task we need you to provide distribution data that includes presence points and pseudo-absences.
