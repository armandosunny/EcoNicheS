...
###### If you already have a different version of biomod2 installed, you can remove it with the following function: 

remove.packages("biomod2") 

and later install the correct version of biomod2 4.2.2.
