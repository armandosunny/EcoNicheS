...
options(shiny.maxRequestSize = 6000*1024^2)
 ...
 ui <- dashboardPage(
     dashboardHeader(title = "EcoNicheS 2.0.0"),
     dashboardSidebar(
         sidebarMenu(
             menuItem("Correlation layers", tabName = "tab1"),
             menuItem("Points and pseudoabsences", tabName = "tab2"),
             menuItem("Biomod2", tabName = "tab3"),
             menuItem("Partial ROC Analysis", tabName = "tab4"),
             menuItem("Remove urbanization", tabName = "tab5"),
             menuItem("Calculate area", tabName = "tab6"),
             menuItem("Gains and Losses Plot", tabName = "tab7")
         )
     ),
     dashboardBody(
         tabItems(
                     ...
                     fluidPage(
                         ...
                         sidebarLayout(
                             sidebarPanel(
                                 ...
                                 sliderInput("threshold", "Umbral (th)", min = 0, max = 1, value = 0.7, step = 0.1),
                     ...
                     fluidPage(
                         ...
                         sidebarLayout(
                             sidebarPanel(
                                 ...
                                 sliderInput("threshold", "Selection Threshold", min = 0, max = 1, value = 0.7, step = 0.1),
